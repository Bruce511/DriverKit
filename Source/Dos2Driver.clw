...
ShortName      Equate('DOS2')                                                          ! 4 Characters long. If the length is changed, then adjust dllName and DsiDllName below
...
TDescAddress   Equate(00a081e8h)       !00854BB4h
...
DRIVER_HAS_HOLDfile                 Equate(NO)
DRIVER_HAS_HOLDfilesec              Equate(NO)
DRIVER_HAS_LOCKfile                 Equate(YES)
DRIVER_HAS_LOCKfilesec              Equate(YES)
